...
var arkImgTop = 3;								// 자동완성 화살표 이미지의 상단에서 위치 값을 설정한다.
var arkImgLeft = 6;							// 자동완성 화살표 이미지의 왼쪽에서 위치 값을 설정한다.
...
function drawArk() {
	...
	// 자동완성 접기/펼침 이미지 생성
	str = "<div id=\"" + arkDownId + "\" style=\"position:absolute; display:block; cursor:pointer;\"><img id=\"" + imgDownId + "\" src=\"/resources/images/ark/arrow_auto.gif\" alt=\"자동완성펼치기\"></div>";
	str += "<div id=\"" + arkUpId + "\" style=\"position:absolute; display:none; cursor:pointer;\"><img id=\"" + imgUpId + "\" src=\"/resources/images/ark/arrow_auto2.gif\" alt=\"자동완성접기\" ></div>";
	
	// 툴팁 이미지 생성
	str += "<div id=\"tooltip01\" style=\"position:absolute; display:none; cursor:pointer; z-index:999999;\"><img id=\"tooltipIcon01\" src=\"/resources/images/ark/tooltip_01.gif\"/></div>";
...
function setArkFooter() {
	...
	if (isArk) {
		...
		if ($(queryId).val() != "" && isListShow) {
			...
			$("body").append("<span style=\"display:none;\"><div id=\"tooltip02\" style=\"position:absolute;\"><img id=\"tooltipIcon02\" src=\"/resources/images/ark/tooltip_02.gif\"/></div></span>");
		} else {
