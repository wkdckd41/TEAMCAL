    ...
    function html5Upload() {	
    	...
    	sUploadURL = '/resources/SmartEditor2/file_uploader_html5.jsp' //upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 	    	...
 	    	sUrl : '/resources/SmartEditor2/file_uploader.jsp',
 	    	sCallback : '/resources/SmartEditor2/photo_uploader/popup/callback.html',
